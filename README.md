...
Use the Dataleonlabs MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.

[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=dataleonlabs-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsImRhdGFsZW9ubGFicy1tY3AiXX0)
[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22dataleonlabs-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22dataleonlabs-mcp%22%5D%7D)
...
```sh
go get -u 'github.com/dataleonlabs/dataleonlabs-go@v0.2.0'
```
...
The dataleonlabs library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/dataleonlabs/dataleonlabs-go/option).
...
`*dataleonlabs.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `dataleonlabs.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/dataleonlabs/dataleonlabs-go/issues) with questions, bugs, or suggestions.
